...
public class ExampleUnitTest {
 ...
 /*
    ...
    @Test
     public void fact1() {
         double resultFact = mCalculator.giaithua(0d);
         assertThat(resultFact, is(equalTo(1d)));
     }
    @Test
    public void fact2() {
        double resultFact = mCalculator.giaithua(1d);
        assertThat(resultFact, is(equalTo(1d)));
    }
    @Test
    public void fact3() {
        double resultFact = mCalculator.giaithua(2d);
        assertThat(resultFact, is(equalTo(2d)));
    }
    @Test
    public void fact4() {
        double resultFact = mCalculator.giaithua(3d);
        assertThat(resultFact, is(equalTo(6d)));
    }
    @Test
    public void fact5() {
        double resultFact = mCalculator.giaithua(4d);
